...
| |
| :-: | :-: | :-: |
| [`ca-certificate`](#--ca-certificate) | [`certificate`](#--certificate) | [`dht-file-path`](#--dht-file-path) |
| [`dht-file-path6`](#--dht-file-path6) | [`dir`](#--dir) | [`input-file`](#--input-file) |
| [`load-cookies`](#--load-cookies) | [`log`](#--log) | [`metalink-file`](#--metalink-file) |
| [`netrc-path`](#--netrc-path) | [`on-bt-download-complete`](#--on-bt-download-complete) | [`on-download-complete`](#--on-download-complete) |
| [`on-download-error`](#--on-download-error) | [`on-download-start`](#--on-download-start) | [`on-download-stop`](#--on-download-stop) |
| [`on-download-pause`](#--on-download-pause) | [`out`](#--out) | [`private-key`](#--private-key) |
| [`rpc-certificate`](#--rpc-certificate) | [`rpc-private-key`](#--rpc-private-key) | [`save-cookies`](#--save-cookies) |
| [`save-session`](#--save-session) | [`server-stat-if`](#--server-stat-if) | [`server-stat-of`](#--server-stat-of) |
...
| |
| :-: | :-: | :-: |
| [`all-proxy`](#--all-proxy) | [`all-proxy-passwd`](#--all-proxy-passwd) | [`all-proxy-user`](#--all-proxy-user) |
| [`allow-overwrite`](#--allow-overwrite) | [`allow-piece-length-change`](#--allow-piece-length-change) | [`always-resume`](#--always-resume) |
| [`async-dns`](#--async-dns) | [`auto-file-renaming`](#--auto-file-renaming) | [`bt-enable-hook-after-hash-check`](#--bt-enable-hook-after-hash-check) |
| [`bt-enable-lpd`](#--bt-enable-lpd) | [`bt-exclude-tracker`](#--bt-exclude-tracker) | [`bt-external-ip`](#--bt-external-ip) |
| [`bt-force-encryption`](#--bt-force-encryption) | [`bt-hash-check-seed`](#--bt-hash-check-seed) | [`bt-load-saved-metadata`](#--bt-load-saved-metadata) |
| [`bt-max-peers`](#--bt-max-peers) | [`bt-metadata-only`](#--bt-metadata-only) | [`bt-min-crypto-level`](#--bt-min-crypto-level) |
| [`bt-prioritize-piece`](#--bt-prioritize-piece) | [`bt-remove-unselected-file`](#--bt-remove-unselected-file) | [`bt-request-peer-speed-limit`](#--bt-request-peer-speed-limit) |
| [`bt-require-crypto`](#--bt-require-crypto) | [`bt-save-metadata`](#--bt-save-metadata) | [`bt-seed-unverified`](#--bt-seed-unverified) |
| [`bt-stop-timeout`](#--bt-stop-timeout) | [`bt-tracker`](#--bt-tracker) | [`bt-tracker-connect-timeout`](#--bt-tracker-connect-timeout) |
| [`bt-tracker-interval`](#--bt-tracker-interval) | [`bt-tracker-timeout`](#--bt-tracker-timeout) | [`check-integrity`](#--check-integrity) |
| [`checksum`](#--checksum) | [`conditional-get`](#--conditional-get) | [`connect-timeout`](#--connect-timeout) |
| [`content-disposition-default-utf8`](#--content-disposition-default-utf8) | [`continue`](#--continue) | [`dir`](#--dir) |
| [`dry-run`](#--dry-run) | [`enable-http-keep-alive`](#--enable-http-keep-alive) | [`enable-http-pipelining`](#--enable-http-pipelining) |
| [`enable-mmap`](#--enable-mmap) | [`enable-peer-exchange`](#--enable-peer-exchange) | [`file-allocation`](#--file-allocation) |
| [`follow-metalink`](#--follow-metalink) | [`follow-torrent`](#--follow-torrent) | [`force-save`](#--force-save) |
| [`ftp-passwd`](#--ftp-passwd) | [`ftp-pasv`](#--ftp-pasv) | [`ftp-proxy`](#--ftp-proxy) |
| [`ftp-proxy-passwd`](#--ftp-proxy-passwd) | [`ftp-proxy-user`](#--ftp-proxy-user) | [`ftp-reuse-connection`](#--ftp-reuse-connection) |
| [`ftp-type`](#--ftp-type) | [`ftp-user`](#--ftp-user) | [`gid`](#--gid) |
| [`hash-check-only`](#--hash-check-only) | [`header`](#--header) | [`http-accept-gzip`](#--http-accept-gzip) |
| [`http-auth-challenge`](#--http-auth-challenge) | [`http-no-cache`](#--http-no-cache) | [`http-passwd`](#--http-passwd) |
| [`http-proxy`](#--http-proxy) | [`http-proxy-passwd`](#--http-proxy-passwd) | [`http-proxy-user`](#--http-proxy-user) |
| [`http-user`](#--http-user) | [`https-proxy`](#--https-proxy) | [`https-proxy-passwd`](#--https-proxy-passwd) |
| [`https-proxy-user`](#--https-proxy-user) | [`index-out`](#--index-out) | [`lowest-speed-limit`](#--lowest-speed-limit) |
| [`max-connection-per-server`](#--max-connection-per-server) | [`max-download-limit`](#--max-download-limit) | [`max-file-not-found`](#--max-file-not-found) |
| [`max-mmap-limit`](#--max-mmap-limit) | [`max-resume-failure-tries`](#--max-resume-failure-tries) | [`max-tries`](#--max-tries) |
| [`max-upload-limit`](#--max-upload-limit) | [`metalink-base-uri`](#--metalink-base-uri) | [`metalink-enable-unique-protocol`](#--metalink-enable-unique-protocol) |
| [`metalink-language`](#--metalink-language) | [`metalink-location`](#--metalink-location) | [`metalink-os`](#--metalink-os) |
| [`metalink-preferred-protocol`](#--metalink-preferred-protocol) | [`metalink-version`](#--metalink-version) | [`min-split-size`](#--min-split-size) |
| [`no-file-allocation-limit`](#--no-file-allocation-limit) | [`no-netrc`](#--no-netrc) | [`no-proxy`](#--no-proxy) |
| [`out`](#--out) | [`parameterized-uri`](#--parameterized-uri) | [`pause`](#--pause) |
| [`pause-metadata`](#--pause-metadata) | [`piece-length`](#--piece-length) | [`proxy-method`](#--proxy-method) |
| [`realtime-chunk-checksum`](#--realtime-chunk-checksum) | [`referer`](#--referer) | [`remote-time`](#--remote-time) |
| [`remove-control-file`](#--remove-control-file) | [`retry-wait`](#--retry-wait) | [`reuse-uri`](#--reuse-uri) |
| [`rpc-save-upload-metadata`](#--rpc-save-upload-metadata) | [`seed-ratio`](#--seed-ratio) | [`seed-time`](#--seed-time) |
| [`select-file`](#--select-file) | [`split`](#--split) | [`ssh-host-key-md`](#--ssh-host-key-md) |
| [`stream-piece-selector`](#--stream-piece-selector) | [`timeout`](#--timeout) | [`uri-selector`](#--uri-selector) |
| [`use-head`](#--use-head) | [`user-agent`](#--user-agent) |
...
- 此方法更改队列中 `gid` 表示的下载位置。

`pos` 是一个整数。
`how` 是一个字符串。
如果 `how` 是 `POS_SET`，它将下载移动到相对于队列开头的位置；
如果 `how` 是 `POS_CUR`，它会将下载移动到相对于当前的位置；
如果 `how` 是 `POS_END`，它会将下载移动到相对于队列末尾的位置。
如果目标位置小于 `0` 或超出队列末尾，它将下载分别移动到队列的开头或结尾。
响应是一个整数，表示结果位置。

例如，如果 `GID#2089b05ecca3d829` 当前位于位置 `3`，
`aria2.changePosition('2089b05ecca3d829', -1, 'POS_CUR')` 会将其位置更改为 `2`。
另外 `aria2.changePosition('2089b05ecca3d829', 0, 'POS_SET')` 会将其位置更改为 `0`（队列的开头）。

以下示例将下载 `GID#2089b05ecca3d829` 移至队列的前面。
...
>>> import urllib2, json
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.changePosition', 'params':['2089b05ecca3d829', 0, 'POS_SET']})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
...
#### <CMD>aria2.changeUri([secret, ]gid, fileIndex, delUris, addUris[, position])</CMD> {#aria2.changeUri}

- 此方法从 `gid` 表示的下载中删除 `delUris` 中的 URI，并将 `addUris` 中的 URI 附加到下载。
- 此方法返回一个包含两个整数的列表。第一个整数是删除的 URI 数。第二个整数是添加的 URI 的数量。

`delUris` 和 `addUris` 是字符串列表。
下载可以包含多个文件，每个文件都附有 URI。

`fileIndex` 用于选择要删除或附加给定 URI 的文件。
`fileIndex` 从 `1` 开始。

`position` 用于指定 URI 在现有等待 URI 列表中的插入位置。
`position` 从 `0` 开始。
当省略 `position` 时，URI 将附加到列表的后面。
该方法先执行删除，然后执行添加。
`position` 是去掉 URI 后的位置，而不是调用该方法时的位置。
删除 URI 时，如果下载中存在相同的 URI，则 delUris 中的每个 URI 只删除其中一个。

换句话说，如果有三个 URI `http://example.org/aria2` 并且你想将它们全部删除，
你必须在 `delUris` 中指定（至少）三个 `http://example.org/aria2`。
...
>>> import urllib2, json
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.changeUri', 'params':['2089b05ecca3d829', 1, [], ['http://example.org/file']]})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
...
#### <CMD>aria2.getOption([secret, ]gid)</CMD> {#aria2.getOption}

- 此方法返回由 `gid` 表示的下载选项。

响应是一个结构，其中键是选项的名称，值是字符串。
请注意，此方法不会返回没有默认值且未在命令行、配置文件或 RPC 方法中设置的选项。
...
>>> import urllib2, json
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.getOption', 'params':['2089b05ecca3d829']})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
{u'id': u'qwer',
 u'jsonrpc': u'2.0',
...
#### <CMD>aria2.changeOption([secret, ]gid, options)</CMD> {#aria2.changeOption}

- 此方法动态更改由 `gid`（字符串）表示的下载选项。
- 此方法返回 `OK` 表示成功。

`options` 是一个结构。可以使用[输入文件](#输入文件)小节中列出的选项，但以下选项除外：

| |
| :-: | :-: | :-: |
| [`dry-run`](#--dry-run) | [`metalink-base-uri`](#--metalink-base-uri) | [`parameterized-uri`](#--parameterized-uri) |
| [`pause`](#--pause) | [`piece-length`](#--piece-length) | [`rpc-save-upload-metadata`](#--rpc-save-upload-metadata) |

除以下选项外，更改主动下载的其他选项使其重启（重启本身由 Aria2 管理，不需要用户干预）：

| |
| :-: | :-: | :-: |
| [`bt-max-peers`](#--bt-max-peers) | [`bt-request-peer-speed-limit`](#--bt-request-peer-speed-limit) | [`bt-remove-unselected-file`](#--bt-remove-unselected-file) |
| [`force-save`](#--force-save) | [`max-download-limit`](#--max-download-limit) | [`max-upload-limit`](#--max-upload-limit) |

以下示例将下载 `GID#2089b05ecca3d829` 的 [`max-download-limit`](#--max-download-limit) 选项设置为 `20K`。
...
>>> import urllib2, json
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.changeOption', 'params':['2089b05ecca3d829', {'max-download-limit':'10K'}]})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
...
#### <CMD>aria2.getGlobalOption([secret])</CMD> {#aria2.getGlobalOption}

- 此方法返回全局选项。

响应是一个结构，其中键是选项的名称，值是字符串。
请注意，此方法不会返回没有默认值且未在命令行、配置文件或 RPC 方法中设置的选项。
由于全局选项用作新添加的下载选项的模板，所以响应包含 [`aria2.getOption()`](#aria2.getOption) 方法返回的键。
<br /><br />




#### <CMD>aria2.changeGlobalOption([secret, ]options)</CMD> {#aria2.changeGlobalOption}
...
| |
| :-: | :-: | :-: |
| [`bt-max-open-files`](#--bt-max-open-files) | [`download-result`](#--download-result) | [`keep-unfinished-download-result`](#--keep-unfinished-download-result) |
| [`log`](#--log) | [`log-level`](#--log-level) | [`max-concurrent-downloads`](#--max-concurrent-downloads) |
| [`max-download-result`](#--max-download-result) | [`max-overall-download-limit`](#--max-overall-download-limit) | [`max-overall-upload-limit`](#--max-overall-upload-limit) |
| [`optimize-concurrent-downloads`](#--optimize-concurrent-downloads) | [`save-cookies`](#--save-cookies) | [`save-session`](#--save-session) |
| [`server-stat-of`](#--server-stat-of) |

此外，可以使用[输入文件](#输入文件)小节中列出的选项，但以下选项除外：

| |
| :-: | :-: | :-: |
| [`checksum`](#--checksum) | [`index-out`](#--index-out) | [`out`](#--out) |
| [`pause`](#--pause) | [`select-file`](#--select-file) |

使用 [`log`](#--log) 选项，你可以动态地开始记录或更改日志文件。
...
#### <CMD>aria2.getGlobalStat([secret])</CMD> {#aria2.getGlobalStat}
...
当前会话中停止的下载数。
该值受 [`--max-download-result`](#--max-download-result) 选项限制。

> `numStoppedTotal`

当前会话中停止的下载数，不受 [`--max-download-result`](#--max-download-result) 选项的限制。
...
>>> import urllib2, json
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.getGlobalStat'})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
{u'id': u'qwer',
 u'jsonrpc': u'2.0',
...
#### <CMD>aria2.purgeDownloadResult([secret])</CMD> {#aria2.purgeDownloadResult}

- 此方法清除已完成／错误／已删除的下载以释放内存。
- 此方法返回 `OK`。
...
#### <CMD>aria2.removeDownloadResult([secret, ]gid)</CMD> {#aria2.removeDownloadResult}

- 此方法从内存中删除由 `gid` 表示的已完成／错误／已删除的下载。
- 如果成功，此方法返回 `OK`。

以下示例删除下载 `GID#2089b05ecca3d829` 的下载结果。
...
>>> import urllib2, json
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.removeDownloadResult', 'params':['2089b05ecca3d829']})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
{u'id': u'qwer', u'jsonrpc': u'2.0', u'result': u'OK'}
```
...
#### <CMD>aria2.getVersion([secret])</CMD> {#aria2.getVersion}

- 此方法返回 Aria2 的版本和已启用功能的列表。
...
>>> import urllib2, json
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.getVersion'})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
{u'id': u'qwer',
 u'jsonrpc': u'2.0',
...
#### <CMD>aria2.getSessionInfo([secret])</CMD> {#aria2.getSessionInfo}
...
>>> import urllib2, json
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.getSessionInfo'})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
{u'id': u'qwer',
 u'jsonrpc': u'2.0',
...
#### <CMD>aria2.shutdown([secret])</CMD> {#aria2.shutdown}
...
#### <CMD>aria2.forceShutdown([secret])</CMD> {#aria2.forceShutdown}

- 此方法关闭 Aria2。
- 此方法返回 `OK`。

此方法的行为类似于 [`aria2.shutdown()`](#aria2.shutdown)，但是不执行任何需要时间的操作，例如联系 BitTorrent Tracker 以先注销下载。
...
#### <CMD>aria2.saveSession([secret])</CMD> {#aria2.saveSession}

- 此方法将当前会话保存到 [`--save-session`](#--save-session) 选项指定的文件中。
- 如果成功，此方法返回 `OK`。
...
#### <CMD>system.multicall(methods)</CMD> {#system.multicall}

- 此方法将多个方法调用封装在一个请求中。
- 此方法返回一个响应数组。

方法是一个结构数组。
结构包含两个键：`methodName` 和 `params`。
`methodName` 是要调用的方法名，`params` 是包含方法调用参数的数组。

如果封装的方法调用失败，元素将是包含方法调用返回值的单项数组，或者是错误元素的结构。

在以下示例中，我们添加了两个下载。
第一个是 `http://example.org/file` 第二个是 `file.torrent`。
...
>>> import urllib2, json, base64
>>> from pprint import pprint
>>> jsonreq = json.dumps({'jsonrpc':'2.0', 'id':'qwer', 'method':'system.multicall', 'params':[[{'methodName':'aria2.addUri', 'params':[['http://example.org']]}, {'methodName':'aria2.addTorrent', 'params':[base64.b64encode(open('file.torrent').read())]}]]})
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
{u'id': u'qwer', u'jsonrpc': u'2.0', u'result': [[u'2089b05ecca3d829'], [u'd2703803b52216d1']]}
```

JSON-RPC还支持批处理请求，如JSON-RRPC 2.0规范所述：

```python {1-3}
>>> jsonreq = json.dumps([{'jsonrpc':'2.0', 'id':'qwer', 'method':'aria2.addUri', 'params':[['http://example.org']]}, {'jsonrpc':'2.0', 'id':'asdf', 'method':'aria2.addTorrent', 'params':[base64.b64encode(open('file.torrent').read())]}])
>>> c = urllib2.urlopen('http://localhost:6800/jsonrpc', jsonreq)
>>> pprint(json.loads(c.read()))
...
#### <CMD>system.listMethods()</CMD> {#system.listMethods}

- 此方法返回字符串数组中的所有可用 RPC 方法。

与其他方法不同，此方法不需要密钥令牌。
这是安全的，因为此方法只返回可用的方法名。
...
#### <CMD>system.listNotifications()</CMD> {#system.listNotifications}

- 此方法返回字符串数组中的所有可用 RPC 通知。

与其他方法不同，此方法不需要密钥令牌。
这是安全的，因为此方法只返回可用的通知名称。
...
通过 JSON-RPC，Aria2 返回一个 JSON 对象，该对象在 `code` 中包含错误代码，在 `message` 中包含错误消息。

通过 XML-RPC，Aria2 返回 `faultCode=1` 和 `faultString` 中的错误消息。
<br /><br />
...
可以使用与 [`--input-file`](#--input-file) 相同的选项。
有关选项的完整列表，请参见 [输入文件](#输入文件) 小节。

在选项结构中，`name` 元素是选项名称（没有前面的`--`），`value` 元素是字符串形式的参数。
...
命令行上允许多次使用 [`header`](#--header) 和 [`index-out`](#--index-out) 选项。
由于结构中的名称应该是唯一的（许多 XML-RPC 库对结构的实现使用哈希或字典），所以单个字符串是不够的。
为了克服这一限制，您可以使用数组和字符串作为值。
...
以下示例添加了带有两个选项的下载：`dir` 和 `header`。
`header` 选项需要两个值，因此它使用一个列表：

```python {1-4}
>>> import xmlrpclib
>>> s = xmlrpclib.ServerProxy('http://localhost:6800/rpc')
>>> opts = dict(dir='/tmp', header=['Accept-Language: ja', 'Accept-Charset: utf-8'])
...
### 在 JSON-RPC 中使用 HTTP GET

JSON-RPC 接口还支持通过 HTTP GET 的请求。
GET 参数中的编码方案是基于 HTTP 的 JSON-RPC 中的规范 [2008-1-15(RC1)]。
GET 参数的编码如下：
...
`method` 和 `id` 始终被视为 JSON 字符串，其编码必须为 UTF-8。

例如，`id='foo'` 和 `aria2.tellStatus('2089b05ecca3d829')` 的编码字符串如下所示：

```text
/jsonrpc?method=aria2.tellStatus&id=foo&params=WyIyMDg5YjA1ZWNjYTNkODI5Il0%3D
```

`params` 参数是 Base64 编码的 JSON 数组，通常出现在 JSON-RPC 请求对象的 `params` 属性中。
在上述示例中，参数为 `[“2089b05ecca3d829”]`，因此：
...
JSON-RPC 接口也支持 JSONP。
您可以在 `jsoncallback` 参数中指定回调函数：

```text
/jsonrpc?method=aria2.tellStatus&id=foo&params=WyIyMDg5YjA1ZWNjYTNkODI5Il0%3D&jsoncallback=cb
```

对于批处理请求，不能指定 `method` 和 `id` 参数。
整个请求必须在 `params` 参数中指定。
例如，批处理请求：
...
基于 WebSocket 的 JSON-RPC 使用与基于 HTTP 的 JSON-RPC 相同的方法签名和响应格式。
支持的 WebSocket 版本为 13，详细信息请参阅 [RFC 6455](#https://tools.ietf.org/html/rfc6455.html)。

要向 RPC 服务器发送 RPC 请求，请在文本帧中发送序列化的 JSON 字符串。
来自 RPC 服务器的响应也在文本帧中传递。

- 通知

RPC 服务器可能会向客户端发送通知。
通知是单向的，因此接收通知的客户端不能对其作出响应。
通知的方法签名与普通方法请求非常相似，但缺少 id 密钥。
params 键的值是此通知携带的数据。
值的格式因通知方法而异。
定义了以下通知方法。
<br /><br />
...
#### <CMD>aria2.onDownloadStart(event)</CMD> {#aria2.onDownloadStart}
...
#### <CMD>aria2.onDownloadPause(event)</CMD> {#aria2.onDownloadPause}

- 暂停下载时将发送此通知。

该 `event` 的结构与 [`aria2.onDownloadStart()`](#aria2.onDownloadStart) 方法的 `event` 参数相同。
<br /><br />




#### <CMD>aria2.onDownloadStop(event)</CMD> {#aria2.onDownloadStop}
...
#### <CMD>aria2.onDownloadComplete(event)</CMD> {#aria2.onDownloadComplete}

- 下载完成后将发送此通知。

对于 BitTorrent 下载，此通知将在下载完成且播种结束时发送。
该 `event` 的结构与 [`aria2.onDownloadStart()`](#aria2.onDownloadStart) 方法的 `event` 参数相同。
<br /><br />
...
#### <CMD>aria2.onDownloadError(event)</CMD> {#aria2.onDownloadError}
...
#### <CMD>aria2.onBtDownloadComplete(event)</CMD> {#aria2.onBtDownloadComplete}

- 当种子下载完成但种子仍在进行时，将发送此通知。
...
以下 Ruby 脚本添加 `http://localhost/aria2.tar.bz2` 到 `aria2c`（在本地主机上运行），使用选项 `--dir=/downloads` 并打印 RPC 响应：
...
如果您是 Python 爱好者，可以使用 xmlrpclib（Python3 改用 xmlrpc.client） 与 Aria2 交互：
...
下载文件时，Aria2 会向控制台打印一个读数，以显示下载进度。
控制台读数如下：
...
GID 的前六个字符作为一个十六进制字符串。
在 Aria2 内部，GID 是每个下载的唯一 ID。
GID 在使用 RPC 接口与 Aria2 交互时特别有用。

- `X/Y(Z%)`

意义：完成长度／文件总长度（进度）。
如果使用 [`--select-file`](#--select-file)，则这是所选文件的总和。

- `SEED`

当 Aria2 做种一个已完成的种子时的分享份额比率。
...
当进行多个下载时，将省略上面描述的一些信息，以便显示多个下载的信息。
整体的下载和上传速度显示在该行的开头。
